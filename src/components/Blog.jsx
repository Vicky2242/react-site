						...
						<div className="single-news">
							...
							<div className="news-body">
								<div className="news-content">
									...
									<h2><a href="/blogs">We have annnocuced our new product.</a></h2>
						...
						<div className="single-news">
							...
							<div className="news-body">
								<div className="news-content">
									...
									<h2><a href="/blogs">Top five way for solving teeth problems.</a></h2>
									<p className="text">Lorem ipsum dolor a sit ameti, consectetur adipisicing elit, sed do eiusmod tempor incididunt sed do incididunt sed.</p>
								</div>
							</div>
						</div>
						...
						<div className="single-news">
							...
							<div className="news-body">
								<div className="news-content">
									...
									<h2><a href="/blogs">We provide highly business soliutions.</a></h2>
									<p className="text">Lorem ipsum dolor a sit ameti, consectetur adipisicing elit, sed do eiusmod tempor incididunt sed do incididunt sed.</p>
								</div>
							</div>
						</div>
